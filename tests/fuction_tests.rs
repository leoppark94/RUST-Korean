...
#[test]
fn test_create_double_consonant() {
    let case1 = vec!['ㄱ', 'ㅅ', 'ㄴ', 'ㅈ', 'ㄹ', 'ㅎ'];
    assert_eq!(create_double_consonant(case1), vec!['ㄳ', 'ㄵ', 'ㅀ']);

    let case2 = vec!['ㄹ', 'ㄱ', 'ㄹ', 'ㅁ', 'ㄹ', 'ㅂ', 'ㄹ', 'ㅅ'];
    assert_eq!(create_double_consonant(case2), vec!['ㄺ', 'ㄻ', 'ㄼ', 'ㄽ']);
